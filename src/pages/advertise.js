        ...
        <div>
            ...
            <table className={styles.table} >
                ...
                <tr>
                    <th>ITT 1.1</th>
                    <td>
                        <p>The reference number of the Invitation for Tenders is:<input type='text' /></p>

                        <p>The Procuring Entity is: <input type='text' /></p>

                        <p>The name of the Contract is:<input type='text' /> </p>
